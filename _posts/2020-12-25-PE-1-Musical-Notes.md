...
repeated. The instructions are similar to brainf\*ck and the comparison chart is below. If a note
...
So, applying this to my brainf\*ck program above, I get the following score where `o` represents a
